...
var Ripple = React4.memo(React4.forwardRef(function(inProps, ref) {
  var _React$useState = React4.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
...
var MenubarSub = React5.memo(React5.forwardRef(function(props, ref) {
  ...
  var createSeparator = function createSeparator2(processedItem, index) {
    ...
    return React5.createElement("li", _extends5({}, separatorProps, {
      key
    }));
  };
  ...
  var createMenuitem = function createMenuitem2(processedItem, index) {
    ...
    var label = item.label && React5.createElement("span", labelProps, item.label);
    ...
    var submenuIcon = items && IconUtils.getJSXIcon(!props.root ? props.submenuIcon || React5.createElement(AngleRightIcon, submenuIconProps) : props.submenuIcon || React5.createElement(AngleDownIcon, submenuIconProps), _objectSpread$1({}, submenuIconProps), {
    ...
    var content = React5.createElement("a", actionProps, icon, label, submenuIcon, React5.createElement(Ripple, null));
    if (item.template) {
    ...
    var menuitemProps = mergeProps(_defineProperty2({
      id,
      "data-id": dataId,
      role: "menuitem",
    ...
    return React5.createElement("li", _extends5({}, menuitemProps, {
      key: "".concat(dataId)
    }), React5.createElement("div", contentProps, content), submenu2);
  };
  ...
  return React5.createElement("ul", menuProps, submenu);
}));
...
var Menubar = React5.memo(React5.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React5.useState(props.id), _React$useState2 = _slicedToArray2(_React$useState, 2), idState = _React$useState2[0], setIdState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), mobileActiveState = _React$useState4[0], setMobileActiveState = _React$useState4[1];
  var _React$useState5 = React5.useState(false), _React$useState6 = _slicedToArray2(_React$useState5, 2), focused = _React$useState6[0], setFocused = _React$useState6[1];
  var _React$useState7 = React5.useState({
    index: -1,
    level: 0,
    parentKey: ""
  }), _React$useState8 = _slicedToArray2(_React$useState7, 2), focusedItemInfo = _React$useState8[0], setFocusedItemInfo = _React$useState8[1];
  var _React$useState9 = React5.useState(null), _React$useState10 = _slicedToArray2(_React$useState9, 2), focusedItemId = _React$useState10[0], setFocusedItemId = _React$useState10[1];
  var _React$useState11 = React5.useState([]), _React$useState12 = _slicedToArray2(_React$useState11, 2), activeItemPath = _React$useState12[0], setActiveItemPath = _React$useState12[1];
  var _React$useState13 = React5.useState([]), _React$useState14 = _slicedToArray2(_React$useState13, 2), visibleItems = _React$useState14[0], setVisibleItems = _React$useState14[1];
  var _React$useState15 = React5.useState([]), _React$useState16 = _slicedToArray2(_React$useState15, 2), processedItems = _React$useState16[0], setProcessedItems = _React$useState16[1];
  var _React$useState17 = React5.useState(false), _React$useState18 = _slicedToArray2(_React$useState17, 2), focusTrigger = _React$useState18[0], setFocusTrigger = _React$useState18[1];
  var _React$useState19 = React5.useState(false), _React$useState20 = _slicedToArray2(_React$useState19, 2), dirty = _React$useState20[0], setDirty = _React$useState20[1];
  var elementRef = React5.useRef(null);
  var rootMenuRef = React5.useRef(null);
  var menuButtonRef = React5.useRef(null);
  var searchValue = React5.useRef("");
  var searchTimeout = React5.useRef(null);
  var reverseTrigger = React5.useRef(false);
  ...
  }), _useEventListener2 = _slicedToArray2(_useEventListener, 2), bindOutsideClickListener = _useEventListener2[0], unbindOutsideClickListener = _useEventListener2[1];
  ...
  }), _useResizeListener2 = _slicedToArray2(_useResizeListener, 2), bindResizeListener = _useResizeListener2[0], unbindResizeListener = _useResizeListener2[1];
  ...
  var changeFocusedItemIndex = function changeFocusedItemIndex2(index) {
    if (focusedItemInfo.index !== index) {
      setFocusedItemInfo(_objectSpread2(_objectSpread2({}, focusedItemInfo), {}, {
        index
      }));
      scrollInView();
    }
  ...
  var createStartContent = function createStartContent2() {
    if (props.start) {
      ...
      return React5.createElement("div", startProps, _start);
    }
    return null;
  };
  var createEndContent = function createEndContent2() {
    if (props.end) {
      ...
      return React5.createElement("div", endProps, _end);
    }
    return null;
  };
  var createMenuButton = function createMenuButton2() {
    ...
    var buttonProps = mergeProps(_defineProperty2(_defineProperty2(_defineProperty2(_defineProperty2({
      ref: menuButtonRef,
      href: "#",
      tabIndex: "0",
    ...
    var icon = props.menuIcon || React5.createElement(BarsIcon, popupIconProps);
    var menuIcon = IconUtils.getJSXIcon(icon, _objectSpread2({}, popupIconProps), {
      props
    });
    var button = React5.createElement("a", buttonProps, menuIcon);
    return button;
  };
  ...
  return React5.createElement("div", rootProps, start, menuButton, submenu, end);
}));
